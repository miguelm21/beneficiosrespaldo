			...
			<div class="col-lg-5 col-md-6 col-sm-12 col-12 my-2">
				<div class="card p-2">
					<div class="card-body">
						...
						<p class="card-text edit-card">This is a widadasdasdasdasdassadasdasdasder carasdasdasdasdasd with supp</p>
					</div>
					<div class="card-footer border-transparent bg-transparent">
						<div class="d-flex">
							<div class="custom-control custom-checkbox mx-1">
								<input type="checkbox" class="custom-control-input" id="customCheck1">
								<label class="custom-control-label custom-checkbox-post ml-2" for="customCheck1">Basic</label>
							</div>
							<div class="custom-control custom-checkbox mx-1">
								<input type="checkbox" class="custom-control-input" id="customCheck2">
								<label class="custom-control-label custom-checkbox-post ml-2" for="customCheck2">Premium</label>
							</div>
							<div class="custom-control custom-checkbox mx-1">
								<input type="checkbox" class="custom-control-input" id="customCheck3">
								<label class="custom-control-label custom-checkbox-post ml-2" for="customCheck3">Black</label>
							</div>
						</div>
						<div class="row align-bottom mt-2">
							<div class="col-lg col text-center nopadding nomargin">
				...
				<div id="carouselExampleIndicators" class="carousel slide edit-carousel" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100 size" src="images/ranking/gastro_1.jpg" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100 size" src="images/ranking/gastro_1.jpg" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100 size" src="images/ranking/gastro_1.jpg" alt="Third slide">
						</div>
					</div>
